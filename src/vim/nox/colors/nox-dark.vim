...
" Finder
let $FZF_DEFAULT_OPTS="--layout=reverse --no-multi --bind tab:down --bind btab:up --margin=1,3 --color 'border:" . s:shade0.gui . "' --color 'gutter:" . s:shade0.gui . "' --color 'hl:" . s:green.gui . "' --color 'hl+:" . s:green.gui . "' --color 'bg+:" . s:shade1.gui . "'"
